...
import {NotifyLeavingController}  from './serverless_files/notify_leaving/notify_leaving';
...
ParserContainer.addExposedParser(new NotifyLeavingController("notify_leaving_controller"));
